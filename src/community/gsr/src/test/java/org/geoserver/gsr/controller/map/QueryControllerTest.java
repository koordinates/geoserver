...
public class QueryControllerTest extends ControllerTest {
    ...
    //         assertTrue(
    //                 "Request with no format parameter; returned " + result,
    ...
    //                 JsonSchemaTest.validateJSON(result, "/gsr/1.0/featureSet.json"));
    //         JSONObject json = JSONObject.fromObject(result);
    //         assertTrue("Request with short envelope; returned " + result,
    ...
    //             assertTrue(
    //                     "No geometry at index " + i + " in " + result,
    ...
    //         assertTrue(
    //                 "Request excluding geometries, but don't specify fields. in this case the
    // geometry should be returned anyway. JSON was "
    //                         + result,
    //                 JsonSchemaTest.validateJSON(result, "/gsr/1.0/featureSet.json"));
    //         json = JSONObject.fromObject(result);
    //         features = json.getJSONArray("features");
