...
public class MapServiceControllerTest extends ControllerTest {
    ...
    //                                         + "&geometryType=esriGeometryPoint&geometry={x: 0, y:
    // 0}"
    //                                         +
    ...
    //         // checking, it was a bug in 2.13.x, for some reason the default geometry in Nulls
    // was not
    //         // respected and it was picking the bound polygon as the geom instead of the point,
    // which is
    //         // null
    //         // (yes, weird dataset)
